...
import { AlertCircle, ArrowLeft, Download, icons, Loader2, Palette, Save, Trash2 } from "lucide-react";
    ...
    return (
      ...
      <div className={containerStyles.grid}>
            ...
            <div className={containerStyles.previewContainer}>
                <div className="text-center mb-4">
                    <div className={statusStyles.completionBadge}>
                     ...
                     <span className="">Preview -{completionPercentage} % Complete</span>
                    </div>
                </div>
        ...
        <Modal isOpen={openThemeSelector} onClose={()=>setOpenThemeSelector(false)} 
            ...
            <div className="" style={{display:"none"}} ref={thumbnailRef}>
