    ...
    return (
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col items-start sm:flex-row sm:items-center justify-between gap-4 
                    mb-8 p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100">
               <div className="flex items-center gap-4">
                 <Tabs tabs={TAB_DATA} activeTab={tabValue} setActiveTab={setTabValue}/>
                 <div className="text-lg font-bold text-gray-800">
                   {resumeTemplates.find(t => t.id === selectedTemplate.theme)?.name || "Select Template"}
                 </div>
               </div>
          ...
          <div className="grid-cols-1 grid lg:grid-cols-5  gap-6 lg:gap-8">
