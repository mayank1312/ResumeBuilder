...
const StepProgress=({progress})=>{
    ...
    return (
        ...
        <div className="relative w-full h-4 bg-white/5 backdrop-blue-2xl overflow-hidden rounded-full border border-white/10">
       ...
       <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-shimmer"></div>
        ...
        {progress > 0 && (
            <div className="absolute top-0 h-full w-8 bg-gradient-to-r from-transparent via-white/60 to-white/30 blue-sm"
