export const landingPageStyles = {
  ...
  // Auth buttons
  desktopAuthButton: "px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-fuchsia-600 hover:to-violet-600 text-white font-bold rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-violet-200",
...
export const cardStyles = {
  ...
  profileCard: "flex items-center gap-3 px-4 py-2 sm:px-5 sm:py-3 bg-white backdrop-blur-xl border border-gray-200 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03]",
  ...
  logoutButton: "text-violet-600 text-[10px] sm:text-xs font-bold cursor-pointer hover:text-fuchsia-600 transition-colors mt-1",
...
export const modalStyles = {
  ...
  header: "flex items-center justify-between p-6 border-b border-violet-100 bg-gradient-to-r from-white to-violet-50 gap-7",
